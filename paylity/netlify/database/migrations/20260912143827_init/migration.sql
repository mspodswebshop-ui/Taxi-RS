...
-- ---------------------------------------------------------------------------
-- Netlify voert deze map met migraties zelf uit bij het uitrollen. Prisma houdt
-- normaal in _prisma_migrations bij wat al gedraaid heeft; die tabel vullen we
-- hier meteen, zodat `npm run db:deploy` later niet dezelfde migratie nog eens
-- probeert uit te voeren op een database die de tabellen al heeft.
-- ---------------------------------------------------------------------------
...
VALUES
  ('00000000-0000-0000-0000-000000000001',
   'netlify-applied-this-migration-outside-of-prisma',
   '20260912143827_init', now(), now(), 1)
