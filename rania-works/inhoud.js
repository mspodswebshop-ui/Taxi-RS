...
var STANDAARD_INHOUD = {
  ...
  werk: [
    {
      titel: 'Restaurant — Reel',
      omschrijving: 'Verticale reel van 21 seconden voor een restaurant. Sfeerbeelden van de zaak en de gerechten, strak op de beat gemonteerd en klaar om te posten op Instagram en TikTok.',
      formaat: '9:16',
      beeld: '',
      link: 'werk/restaurant-reel.mp4'
    }
  ],
